    ...
    <section id="contact" className="bg-card py-20 sm:py-24 md:py-32 lg:py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
        <div className="text-center mb-16 sm:mb-20">
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-serif font-bold text-primary mb-6">
            Contact Us
          </h2>
          <p className="text-lg sm:text-xl text-primary/70 max-w-2xl mx-auto leading-relaxed px-4">
            Reach out to discuss how we can support your business needs across
            the GCC and UK
          </p>
        </div>
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12">
              ...
              <div className="border-l-2 border-accent pl-5 sm:pl-6 py-2">
                <h3 className="text-lg sm:text-xl font-serif font-bold text-primary mb-3">
                  Dubai Office
                </h3>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
              <div className="space-y-2">
                <label className="text-xs sm:text-sm font-medium text-primary tracking-wide">
                  Name
                </label>
                <input
                  type="text"
